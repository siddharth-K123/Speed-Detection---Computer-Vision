    ...
    def update(self, objects_rect):
        ...
        for rect in objects_rect:
            ...
            for id, pt in self.center_points.items():      #calculates the euclidean distance
                ...
                if dist < 35:
                    self.center_points[id] = (cx, cy) #proximity between the newly detected object and each previously tracked object.     
#                    print(self.center_points)
                    objects_bbs_ids.append([x, y, w, h, id])
                    same_object_detected = True       # newly detected object corresponds to the same object previously tracked.
                    break
